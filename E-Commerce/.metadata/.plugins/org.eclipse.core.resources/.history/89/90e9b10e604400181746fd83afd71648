...
public class DBConfiguration {
	//to create beans
		...
		public DataSource getDataSource() {
		    ...
		    dataSource.setUrl("jdbc:h2:tcp://localhost/~/milan11");
		...
		public SessionFactory sessionFactory() {
			System.out.println("entering sessionfactory creation mathod");
			LocalSessionFactoryBuilder lsf=
					new LocalSessionFactoryBuilder(getDataSource());
			System.out.println("after localsessionfactorybuileder");
			...
			Class classes[]=new Class[]{Product.class,Category.class,Authorities.class,BillingAddress.class,Cart.class,Customer.class,ShippingAddress.class,User.class};//also write package name
