...
<script type="text/javascript" 
	src="https://cdn.jsdeliver.net/jquery.validation/1.15.1/jquery.validate.min.js"></script>
<script type="text/javascript">
...
$(document).ready(function(){
	$('#form').validate({
		...
		messages:{
			...
			"user.email":{required:"Email is required",email:"Plase enter valid Email"}
		}
	})
})
</script>
...
<label>
check this if billing address and shipping address are same
</label>
